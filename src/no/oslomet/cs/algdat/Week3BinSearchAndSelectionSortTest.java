 ...
 */
class Week3BinSearchAndSelectionSortTest {
    ...
    void findMax() {
        ...
        int max_1 = Week3BinSearchAndSelectionSort.findMax(values, 0, 4);
        assertEquals(1, max_1);
        assertEquals(7, values[max_1]);

        //Search in [2, 4]
        int max_2 = Week3BinSearchAndSelectionSort.findMax(values, 2, 4);
    ...
    void selectionSort() {
        ...
        Week3BinSearchAndSelectionSort.selectionSort(values);
    ...
    void binarySearch() {
        ...
        //Search for 7
        int index_7 = Week3BinSearchAndSelectionSort.binarySearch(values, 7);
        assertEquals(4, index_7);

        //Search for 8 (not found, should be in place 5)
        int index_8 = Week3BinSearchAndSelectionSort.binarySearch(values, 8);
